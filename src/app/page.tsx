...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-black text-white flex flex-col justify-center items-center px-4 py-20 font-mono relative overflow-hidden">
      {/* Background Ambience */}
      ...
      {/* Label Otoritas */}
      <div className="flex items-center gap-2 text-primary mb-6 border border-primary/30 px-3 py-1 rounded-full text-[10px] tracking-[0.3em] uppercase animate-pulse">
        <ShieldAlert size={14} />
        Sistem Deteksi Delusi Aktif
      </div>

      {/* Main Headline */}
      <h1 className="text-4xl md:text-7xl font-black text-center mb-6 tracking-tighter uppercase leading-none">
      ...
      {/* Sub-headline */}
      <p className="max-w-xl text-center text-muted-foreground text-sm md:text-base mb-10 leading-relaxed">
